        ...
        <div className="flex items-center justify-between h-18">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="flex items-center gap-2 bg-brand-green-dark text-white text-sm font-semibold px-6 py-2.5 rounded-full shadow-md hover:bg-brand-green transition-colors duration-300"
            >
      ...
      >
        <div className="glass mx-4 mb-4 rounded-2xl p-4 shadow-xl">
          ...
          <a
            href="tel:+48517740099"
            onClick={() => setMobileOpen(false)}
            className="flex items-center justify-center gap-2 mt-2 bg-brand-green-dark text-white text-sm font-semibold px-5 py-3 rounded-full hover:bg-brand-green transition-colors duration-300"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
            +48 517 740 099
          </a>
